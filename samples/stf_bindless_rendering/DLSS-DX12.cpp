...
#if ENABLE_DLSS && DLSS_WITH_DX12

#include "../../external/DLSS/include/nvsdk_ngx.h"
...
public:
        ...
        uint32_t outputWidth, uint32_t outputHeight, NVSDK_NGX_PerfQuality_Value qualityMode) override
    {
        ...
        result = NGX_D3D12_CREATE_DLSS_EXT(d3dcmdlist, 1, 1, &m_DlssHandle, m_Parameters, &dlssParams);
